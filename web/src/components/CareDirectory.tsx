...
import { Search, MapPin, ExternalLink, Phone, Mail, CheckCircle2, Building2, Users } from 'lucide-react';
            ...
            <table className="w-full text-left text-xs sm:text-sm">
              <thead className="bg-slate-50 dark:bg-slate-850 text-slate-600 dark:text-slate-400 font-semibold border-b border-slate-200 dark:border-slate-800">
                <tr>
                  ...
                  <th className="py-3 px-4">Dementia Speciality</th>
                ...
                <div className="pt-3 border-t border-slate-100 dark:border-slate-800 text-xs space-y-1.5">
                  ...
                  {ngo.website && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center space-x-1.5 text-emerald-600 dark:text-emerald-400 font-semibold hover:underline pt-1"
                    >
