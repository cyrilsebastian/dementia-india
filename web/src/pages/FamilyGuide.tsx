    ...
    <div className="space-y-12 max-w-5xl mx-auto pb-16">
      ...
      <section className="bg-gradient-to-b from-emerald-500/10 via-emerald-500/5 to-transparent dark:from-emerald-950/30 dark:via-emerald-950/10 dark:to-transparent rounded-3xl border border-emerald-200/80 dark:border-emerald-800/50 p-6 sm:p-8 lg:p-10 shadow-xs">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          {/* Left Column: Inspiring Hero Message */}
          ...
          {/* Right Column: Immediate Caregiver Helplines & Roadmap */}
          <div className="lg:col-span-5 flex flex-col space-y-3.5">
            <div className="bg-white/85 dark:bg-slate-900/90 backdrop-blur-xs rounded-2xl border border-emerald-200/90 dark:border-emerald-800/80 p-5 sm:p-6 shadow-sm space-y-3.5">
              ...
              <div className="space-y-2.5">
                <a
                  href="tel:14567"
                  className="flex items-center justify-between p-3 rounded-xl bg-emerald-50/80 dark:bg-emerald-950/60 border border-emerald-200 dark:border-emerald-800 hover:bg-emerald-100/90 dark:hover:bg-emerald-900/70 transition-colors group"
                >
                ...
                <a
                  href="tel:14416"
                  className="flex items-center justify-between p-3 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors group"
                >
                  <div className="space-y-0.5">
                    <div className="text-xs font-bold text-slate-900 dark:text-white group-hover:text-emerald-700 dark:group-hover:text-emerald-300">
                      Tele-MANAS 24×7
